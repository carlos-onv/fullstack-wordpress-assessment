...
function fsl_widgets_init() {
   ...
   */
   ...
   register_sidebar( array(
    'name'            => __( 'Mainbody Widget Area 1', 'fsl' ),
    'id'              => 'mainbody-widget-area-1',
    'description'     => __( 'Use 1, 2, 3 or 4 widgets.', 'fsl' ),
    'before_widget'   => '<aside class="card small mb-3 default-sidebar">',
    'after_widget'    => '</aside>',
  ...
  register_sidebar( array(
    'name'            => __( 'Footer Widget Area', 'fsl' ),
...
add_action( 'widgets_init', 'fsl_widgets_init' );